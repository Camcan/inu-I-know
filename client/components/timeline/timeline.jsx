...
const timeline = [
  {
    ...
    brief: [
      "Since December 2017, I have been working on a number of personal and commercial projects. While some of my projects visible on this site, work for clients includes Full-Stack website builds using NodeJS & aid with documentation-heavy Wordpress integrations.",
...
export default class Timeline extends Component {
  ...
  handleScroll() {
    ...
    let offsetRatio =
      (this.state.initialPosition.top - container.getBoundingClientRect().top) /
          ...
          {timeline.map((item) => {
            return (
              <div
                ...
                className={[
                  Styles.item,
                  this.state.selectedProject == item.slug
                    ? Styles.selected
                    : "",
                ].join(" ")}
              >
